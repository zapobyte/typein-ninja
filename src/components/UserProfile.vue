            ...
            <div class="row no-gutters align-items-start ">
                <div class="text-left col-xs-12 col-md-6">
                    <div class="row no-gutters ">
                        <div class="col-12">
                            <input type="text" id="name_field" class="text__small nes-input" :class="{'border-success':uploaded}"  :value="userDisplayName" @blur="updateDisplayName" :disabled="!isAuthUser" data-toggle="tooltip" data-placement="top" title="Click to edit username"/>
                        </div>
                        <div class="col-12 pt-3 text__small">
                            <div class="row  align-items-center">
                                <div class="col-xs-12 col-lg-6  text-center">
                                    <i class="nes-icon mr-3 is-small is-full star"></i>LVL {{ user ? user.lvl : '' }} 
                                </div>
                                <div class="col-xs-12 col-lg-6 text-center">
